<?php
class Ajax_Response_Edit_ConfigIngredients extends Ajax_Response_Abstract{
	...
	public function layoutCenter_Action(){		
		...
		$elements =	array("zf" 	=> 	array("name", array("name"=>"description", "type"=>"textarea"), "category", "default_unit", "notes"),
						//"db" 	=> 	array("id_award", "award_name", "order_nr", "order_date", "awards_type"), //always start with the primary key
						  "alias"=> array("ID","Perberesi","Njesia Baze","Kategoria"));
		...
		$myGrid->addAutoComplete("category", "Ajax_Response_Utility", "getIngredientsCategories",
				array(	"value" => 'id, name',
						"id" => 'id',
						"label" => 'name'),
