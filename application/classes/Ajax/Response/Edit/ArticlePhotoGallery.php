<?php
class Ajax_Response_Edit_ArticlePhotoGallery extends Ajax_Response_Abstract{
	...
	public function layoutCenter_Action(){		
		...
		if(isset($_SESSION['article']['selected'])){
		    ...
		    $article_obj = new Table_BlogArticles();
		    $article = $article_obj->getDataById($_SESSION['article']['selected']);
		    
		$header = $this->renderBreadCrumb($article->title);
		...
		$html .= '<!-- BEGIN JAVASCRIPTS(Load javascripts at bottom, this will reduce page load time) -->
		    ...
		    echo "Zgjidhni nje artikull fillimisht!";
		}
