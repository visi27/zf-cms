<?php
class Ajax_Response_Edit_BlogSections extends Ajax_Response_Abstract{
	...
	public function layoutCenter_Action(){		
		...
		$elements =	array("zf" 	=> 	array("title", array("name"	=>	"description", "type"	=>	"textarea")),
						//"db" 	=> 	array("id_award", "award_name", "order_nr", "order_date", "awards_type"), //always start with the primary key
						  "alias"=> array("ID","Seksioni","Pershkrimi"));
