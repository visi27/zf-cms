...
class Form_WebSponsored extends Zend_Form {
	...
	public function __construct($options = null) {
		...
		$section_id = new Zend_Form_Element_Text('section_id', array ('class' => 'form-control' ));
		$section_id	->setLabel ( $tr->_('Seksioni') )
		->setAttrib('onclick', '$(this).autocomplete( "search", $(this).val() );')
		->setOptions ( array ('size' => '30') )
		->setRequired ( true )
