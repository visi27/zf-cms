...
class Form_BlogCategories extends Zend_Form {
	...
	public function __construct($options = null) {
        ...
        $section = new Zend_Form_Element_Text('section', array ('class' => 'form-control' ));
        $section	->setLabel ( $tr->_('Seksioni') )
