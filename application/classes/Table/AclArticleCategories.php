...
class Table_AclArticleCategories extends Table_Abstract implements Interface_iForm
{

    protected $_name = 'sys_acl_article_categories';
    ...
    public function selectRowsForGrid($filters = array(), $sortField = null, $sortDir = null)
    {
        ...
        $select->setIntegrityCheck(false)
            ...
            ->join("blog_categories", "$this->_name.category = blog_categories.id", "")
    ...
    public function selectRowForGrid(array $args)
    {
        ...
        $select->setIntegrityCheck(false)
            ...
            "CONCAT(blog_categories.id,' - ',blog_categories.title) as category",
            "read",
            "write"
        ))
            ->join("blog_categories", "$this->_name.category = blog_categories.id", "")
