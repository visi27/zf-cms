 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZExt_Validate_Int extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::INVALID => "Tip i gabuar i te dhenave pritet string ose integer",
        self::NOT_INT => "'%value%' nuk eshte integer",
    );
